"""Drawing the mascot: cross-fades, the idle drift, and the breathing bob.
...
from gui.assets import asset_path
...
class MascotAnimator(QObject):
    ...
    def stop(self) -> None:
        for timer in (self._idle_timer, self._bob_timer, self._fade_timer, self._revert_timer):
            timer.stop()
