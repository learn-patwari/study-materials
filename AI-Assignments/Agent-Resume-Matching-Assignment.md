# Assignment: Agentic Resume Matching System

## Overview
Build a LangGraph-based agent that matches candidate resumes to job
descriptions, supports conversational interaction, and produces
explainable hire/no-hire recommendations.
